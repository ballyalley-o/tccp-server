...
describe('CourseLecture model', () => {
  ...
  test('creates lecture with defaults', async () => {
    ...
    const course   = await Course.create({ title: 'C2', slug: 'c2', description: 'Long enough description for testing purposes', duration: '1', tuition: 10, minimumSkill: 'beginner', bootcamp: bootcamp._id, user: userId } as any)
