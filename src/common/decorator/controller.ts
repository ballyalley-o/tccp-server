...
import { pathBuilder }     from '@common/util'
import { AppRouter }       from '@app.router'
import { Method, MetaKey } from '@common/constant/enum'
import { autoValidate }    from '@common/decorator/body-validator'
...
function controller(routePrefix: string) {
  return function (target: Function) {
    ...
    Object.getOwnPropertyNames(target.prototype).forEach((key) => {
      ...
      if (path) {
        let connectedPath = pathBuilder(PathDir.API_ROOT, routePrefix, path)
